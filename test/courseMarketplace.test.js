...
//****************** "T R U F F L E   T E S T"   T O   R U N   I N   C O N S O L E */
...
contract("CourseMarketplace", accounts => {
  ...
  describe("Activate the purchased course", () => {
    ...
    //Test for unowner activation. For below code block, above is commented
  ...
  describe("Transfer ownership", () => {
    ...
    it("should transfer owership to 3rd address from 'accounts'", async () => {
      ...
      console.log("Transferin ownership to: " + accounts[2])
    })
    ...
    it("should transfer owership back to initial contract owner'", async () => {
      ...
      const owner = await _contract.getContractOwner()
      console.log("Latest owner: " + owner)
